  ...
  return (
    <>
      ...
      <div className="pagination">
        <button className='exchange' onClick={handlePrevious} disabled={offset === 0}>
        back
        </button>
        <button className='exchange' onClick={handleNext}>Next</button>
      </div>
      {error && (
        <div className="error">
          <p>No such pakemon Please try again.</p>
        </div>
      )}
